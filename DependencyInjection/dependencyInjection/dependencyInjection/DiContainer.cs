...
namespace dependencyInjection
{
    public class DiContainer
    {
        ...
        private object GetImplementation(Type type)
        {
            ...
            Type implementation;
            _types.TryGetValue(type, out implementation);
            ...
            {
                constructorParamImplementations
                    .Add(GetImplementation(param.ParameterType));
            }

            return constructorInfo
                .Invoke(constructorParamImplementations.ToArray());
        }
    }
}